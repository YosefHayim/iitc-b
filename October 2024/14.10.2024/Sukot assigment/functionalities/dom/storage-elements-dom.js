...
const homePageAllContainers = document.querySelectorAll('.popular-of-day-container, .popular-movies-of-week-container, .fav-movies-container, .currently-movies-in-theatres-container, .upcoming-movies-container, .popular-movies-container, .top-trending-movies-container');
...
const popularOfTheDayContainer = document.querySelector('.popular-of-day-container');
const popularOfTheWeekContainer = document.querySelector('.popular-movies-of-week-container');
...
const alertMessageContainerEl = document.querySelector('.alert-message-container');
