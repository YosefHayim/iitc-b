      ...
      <div className={styles}>
        ...
        <div className="flex flex-row w-full gap-[0.5em]">
          <div className="relative w-3/4">
            <Input
              className="w-full p-2 pl-4 pr-10 border border-white rounded-[100em] bg-white"
              placeholder="Search for a job..."
            />
            <GoSearch className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 focus:border-transparent" />
          </div>
